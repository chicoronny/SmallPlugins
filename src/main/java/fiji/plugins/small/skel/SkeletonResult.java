...
public class SkeletonResult
{
	...
	public void setListOfEndPoints(List<Point> listOfEndPoints2)
	{
		this.listOfEndPoints = listOfEndPoints2;
	}

	public void setListOfJunctionVoxels(List<Point> listOfJunctionVoxels2)
	{
		this.listOfJunctionVoxels = listOfJunctionVoxels2;
	}

	public void setListOfSlabVoxels(List <Point> listOfSlabVoxels)
	{
		this.listOfSlabVoxels = listOfSlabVoxels;
	}

	public void setListOfStartingSlabVoxels(List <Point> listOfStartingSlabVoxels)
	{
		this.listOfStartingSlabVoxels = listOfStartingSlabVoxels;
	}
	public void setShortestPathList(List <Double> shortestPathList)
	{
	...
	public List <Point> getListOfEndPoints()
	{
		return listOfEndPoints;
	}

	public List <Point> getListOfJunctionVoxels()
	{
		return listOfJunctionVoxels;
	}

	public List <Point> getListOfSlabVoxels()
	{
		return listOfSlabVoxels;
	}

	public List <Point> getListOfStartingSlabVoxels()
	{
		return listOfStartingSlabVoxels;
	}

	public List <Double> getShortestPathList()
	{
