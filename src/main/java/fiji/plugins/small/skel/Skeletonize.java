...
public class Skeletonize implements Runnable{
	...
	public Skeletonize(ImagePlus imp){
		this.imRef = imp;
	}
	...
	public void run() {
		...
		this.imRef.updateImage();
	}

	private void computeThinImage(ImageStack outputImage) {
